...
@XmlRootElement(name = "CARS110Event")
public class CARS110Event {
    ...
    protected CARS110Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS110Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS110Event.CARSEventHeader }
     *     
     */
    public CARS110Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS110Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS110Event.CARSEventDetail }
     *     
     */
    public CARS110Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS110Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        @XmlElement(name = "AdjustmentTypeCode", required = true, defaultValue = "INCREASE")
        protected TAdjustmentType adjustmentTypeCode;
        @XmlElement(name = "AccountingCode")
        protected CARS110Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "Amount", required = true)
        protected BigDecimal amount;
        @XmlElement(name = "Participants")
        protected CARS110Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS110Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS110Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS110Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS110Event.CARSEventDetail.Participants }
         *     
         */
        public CARS110Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS110Event.CARSEventDetail.Participants value) {
