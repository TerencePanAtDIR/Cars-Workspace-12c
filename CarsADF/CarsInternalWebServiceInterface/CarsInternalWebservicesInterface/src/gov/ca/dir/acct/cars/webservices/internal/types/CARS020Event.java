...
import gov.ca.dir.acct.cars.webservices.internal.types.common.TPaymentTermsCode;
 ...
 *                   &lt;element name="ReferenceDocument" type="{http://www.dir.ca.gov/acct/cars/schema/common}tDocumentNumber" minOccurs="0"/>
 *                   &lt;element name="AdditionalReference" type="{http://www.dir.ca.gov/acct/cars/schema/common}tDocumentNumber" minOccurs="0"/>
 *                   &lt;element name="EventDate" type="{http://www.dir.ca.gov/acct/cars/schema/common}tBusinessDate"/>
 *                   &lt;element name="PaymentTermsCode" type="{http://www.dir.ca.gov/acct/cars/schema/common}tPaymentTermsCode" minOccurs="0"/>
...
@XmlRootElement(name = "CARS020Event")
public class CARS020Event {
    ...
    protected CARS020Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS020Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS020Event.CARSEventHeader }
     *     
     */
    public CARS020Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS020Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS020Event.CARSEventDetail }
     *     
     */
    public CARS020Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS020Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected TPaymentTermsCode paymentTermsCode;
        @XmlElement(name = "Note")
        protected TNote note;
        @XmlElement(name = "AccountingCode")
        protected CARS020Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "Amount", required = true)
        protected BigDecimal amount;
        @XmlElement(name = "Participants", required = true)
        protected CARS020Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link TPaymentTermsCode }
         *     
         */
        public TPaymentTermsCode getPaymentTermsCode() {
         ...
         *     
         */
        public void setPaymentTermsCode(TPaymentTermsCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS020Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS020Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS020Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS020Event.CARSEventDetail.Participants }
         *     
         */
        public CARS020Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS020Event.CARSEventDetail.Participants value) {
