...
@XmlRootElement(name = "CARS330Event")
public class CARS330Event {
    ...
    protected CARS330Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS330Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS330Event.CARSEventHeader }
     *     
     */
    public CARS330Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS330Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS330Event.CARSEventDetail }
     *     
     */
    public CARS330Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS330Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS330Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "AdjustmentTypeCode", required = true, defaultValue = "EFT_REJECT")
        protected TAdjustmentType adjustmentTypeCode;
        @XmlElement(name = "Note")
        protected TNote note;
        @XmlElement(name = "Participants")
        protected CARS330Event.CARSEventDetail.Participants participants;
        @XmlElement(name = "Deposit", required = true)
        protected CARS330Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS330Event.CARSEventDetail.Receipt receipt;
         ...
         * @return
         *     possible object is
         *     {@link CARS330Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS330Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS330Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS330Event.CARSEventDetail.Participants }
         *     
         */
        public CARS330Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS330Event.CARSEventDetail.Participants value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS330Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS330Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS330Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS330Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS330Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS330Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
