...
@XmlRootElement(name = "CARS405Event")
public class CARS405Event {
    ...
    protected CARS405Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS405Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS405Event.CARSEventHeader }
     *     
     */
    public CARS405Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS405Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS405Event.CARSEventDetail }
     *     
     */
    public CARS405Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS405Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS405Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS405Event.CARSEventDetail.Participants }
         *     
         */
        public CARS405Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS405Event.CARSEventDetail.Participants value) {
