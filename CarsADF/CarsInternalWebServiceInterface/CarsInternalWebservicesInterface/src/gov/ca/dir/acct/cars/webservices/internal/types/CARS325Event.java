...
@XmlRootElement(name = "CARS325Event")
public class CARS325Event {
    ...
    protected CARS325Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS325Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS325Event.CARSEventHeader }
     *     
     */
    public CARS325Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS325Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS325Event.CARSEventDetail }
     *     
     */
    public CARS325Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS325Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS325Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "AdjustmentTypeCode", required = true, defaultValue = "CREDIT_CARD_REJECT")
        protected TAdjustmentType adjustmentTypeCode;
        @XmlElement(name = "Note")
        protected TNote note;
        @XmlElement(name = "Participants")
        protected CARS325Event.CARSEventDetail.Participants participants;
        @XmlElement(name = "Deposit", required = true)
        protected CARS325Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS325Event.CARSEventDetail.Receipt receipt;
         ...
         * @return
         *     possible object is
         *     {@link CARS325Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS325Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS325Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS325Event.CARSEventDetail.Participants }
         *     
         */
        public CARS325Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS325Event.CARSEventDetail.Participants value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS325Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS325Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS325Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS325Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS325Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS325Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
