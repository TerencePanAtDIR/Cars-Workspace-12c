 ...
 *                   &lt;element name="AdditionalReferenceNumber" type="{http://www.dir.ca.gov/acct/cars/schema/common}tDocumentNumber" minOccurs="0"/>
...
@XmlRootElement(name = "CARS441Event")
public class CARS441Event {
    ...
    protected CARS441Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS441Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS441Event.CARSEventHeader }
     *     
     */
    public CARS441Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS441Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS441Event.CARSEventDetail }
     *     
     */
    public CARS441Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS441Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS441Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS441Event.CARSEventDetail.Participants }
         *     
         */
        public CARS441Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS441Event.CARSEventDetail.Participants value) {
