...
@XmlRootElement(name = "CARS160Event")
public class CARS160Event {
    ...
    protected CARS160Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS160Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS160Event.CARSEventHeader }
     *     
     */
    public CARS160Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS160Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS160Event.CARSEventDetail }
     *     
     */
    public CARS160Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS160Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        @XmlElement(name = "AdjustmentTypeCode", required = true, defaultValue = "WRITE_OFF")
        protected TAdjustmentType adjustmentTypeCode;
        @XmlElement(name = "AccountingCode")
        protected CARS160Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "Participants")
        protected CARS160Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS160Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS160Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS160Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS160Event.CARSEventDetail.Participants }
         *     
         */
        public CARS160Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS160Event.CARSEventDetail.Participants value) {
