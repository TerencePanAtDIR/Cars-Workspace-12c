...
@XmlRootElement(name = "CARS415Event")
public class CARS415Event {
    ...
    protected CARS415Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS415Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS415Event.CARSEventHeader }
     *     
     */
    public CARS415Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS415Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS415Event.CARSEventDetail }
     *     
     */
    public CARS415Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS415Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS415Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS415Event.CARSEventDetail.Participants }
         *     
         */
        public CARS415Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS415Event.CARSEventDetail.Participants value) {
