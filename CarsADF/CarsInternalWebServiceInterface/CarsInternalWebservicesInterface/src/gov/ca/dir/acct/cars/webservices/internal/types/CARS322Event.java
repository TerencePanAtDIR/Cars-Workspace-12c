...
@XmlRootElement(name = "CARS322Event")
public class CARS322Event {
    ...
    protected CARS322Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS322Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS322Event.CARSEventHeader }
     *     
     */
    public CARS322Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS322Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS322Event.CARSEventDetail }
     *     
     */
    public CARS322Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS322Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS322Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "AdjustmentTypeCode", required = true, defaultValue = "UNBILLED_REJECT")
        protected TAdjustmentType adjustmentTypeCode;
        @XmlElement(name = "Note")
        protected TNote note;
        @XmlElement(name = "Participants")
        protected CARS322Event.CARSEventDetail.Participants participants;
        @XmlElement(name = "Deposit", required = true)
        protected CARS322Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS322Event.CARSEventDetail.Receipt receipt;
         ...
         * @return
         *     possible object is
         *     {@link CARS322Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS322Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS322Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS322Event.CARSEventDetail.Participants }
         *     
         */
        public CARS322Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS322Event.CARSEventDetail.Participants value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS322Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS322Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS322Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS322Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS322Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS322Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
