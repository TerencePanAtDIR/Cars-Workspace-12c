...
@XmlRootElement(name = "CARS430Event")
public class CARS430Event {
    ...
    protected CARS430Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS430Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS430Event.CARSEventHeader }
     *     
     */
    public CARS430Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS430Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS430Event.CARSEventDetail }
     *     
     */
    public CARS430Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS430Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS430Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS430Event.CARSEventDetail.Participants }
         *     
         */
        public CARS430Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS430Event.CARSEventDetail.Participants value) {
