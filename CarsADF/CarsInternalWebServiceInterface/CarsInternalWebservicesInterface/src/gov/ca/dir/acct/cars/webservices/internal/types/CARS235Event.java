...
@XmlRootElement(name = "CARS235Event")
public class CARS235Event {
    ...
    protected CARS235Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS235Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS235Event.CARSEventHeader }
     *     
     */
    public CARS235Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS235Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS235Event.CARSEventDetail }
     *     
     */
    public CARS235Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS235Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS235Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "Amount", required = true)
        protected BigDecimal amount;
        @XmlElement(name = "Participants")
        protected CARS235Event.CARSEventDetail.Participants participants;
        @XmlElement(name = "Deposit", required = true)
        protected CARS235Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS235Event.CARSEventDetail.Receipt receipt;
         ...
         * @return
         *     possible object is
         *     {@link CARS235Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS235Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS235Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS235Event.CARSEventDetail.Participants }
         *     
         */
        public CARS235Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS235Event.CARSEventDetail.Participants value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS235Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS235Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS235Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS235Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS235Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS235Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
