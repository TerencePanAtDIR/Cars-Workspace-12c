...
@XmlRootElement(name = "CARS535Event")
public class CARS535Event {
    ...
    protected CARS535Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS535Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS535Event.CARSEventHeader }
     *     
     */
    public CARS535Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS535Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS535Event.CARSEventDetail }
     *     
     */
    public CARS535Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS535Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        @XmlElement(name = "CurrentDocument", required = true, defaultValue = "ROOT-535-DATE")
        ...
        protected CARS535Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "AdjustmentTypeCode", required = true, defaultValue = "INCREASE_CONTINGENT")
        ...
        protected CARS535Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS535Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS535Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS535Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS535Event.CARSEventDetail.Participants }
         *     
         */
        public CARS535Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS535Event.CARSEventDetail.Participants value) {
        ...
        public static class AccountingCode {
            ...
            protected CARS535Event.CARSEventDetail.AccountingCode.Contingent contingent;
            @XmlElement(name = "Adjustment", required = true)
            protected CARS535Event.CARSEventDetail.AccountingCode.Adjustment adjustment;
             ...
             * @return
             *     possible object is
             *     {@link CARS535Event.CARSEventDetail.AccountingCode.Contingent }
             *     
             */
            public CARS535Event.CARSEventDetail.AccountingCode.Contingent getContingent() {
                return contingent;
            }
             ...
             *     
             */
            public void setContingent(CARS535Event.CARSEventDetail.AccountingCode.Contingent value) {
             ...
             * @return
             *     possible object is
             *     {@link CARS535Event.CARSEventDetail.AccountingCode.Adjustment }
             *     
             */
            public CARS535Event.CARSEventDetail.AccountingCode.Adjustment getAdjustment() {
                return adjustment;
            }
             ...
             *     
             */
            public void setAdjustment(CARS535Event.CARSEventDetail.AccountingCode.Adjustment value) {
