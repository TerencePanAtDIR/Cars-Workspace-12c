...
{
  @WebServiceRef
  private static CARSIntakeWebService cARSIntakeWebService;

    public static void main(String[] args) {
        try {
            cARSIntakeWebService = new CARSIntakeWebService();
            Execute_ptt execute_ptt = cARSIntakeWebService.getExecute_pt();

            Map<String, Object> requestContext = ((BindingProvider) execute_ptt).getRequestContext();
