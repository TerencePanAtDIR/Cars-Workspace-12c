...
@XmlRootElement(name = "CARS520Event")
public class CARS520Event {
    ...
    protected CARS520Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS520Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS520Event.CARSEventHeader }
     *     
     */
    public CARS520Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS520Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS520Event.CARSEventDetail }
     *     
     */
    public CARS520Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS520Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        @XmlElement(name = "CurrentDocument", required = true, defaultValue = "ROOT-520-DATE")
        ...
        protected CARS520Event.CARSEventDetail.AccountingCode accountingCode;
        ...
        protected CARS520Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS520Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS520Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS520Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS520Event.CARSEventDetail.Participants }
         *     
         */
        public CARS520Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS520Event.CARSEventDetail.Participants value) {
        ...
        public static class AccountingCode {
            ...
            protected CARS520Event.CARSEventDetail.AccountingCode.Contingent contingent;
            @XmlElement(name = "Adjustment", required = true)
            protected CARS520Event.CARSEventDetail.AccountingCode.Adjustment adjustment;
             ...
             * @return
             *     possible object is
             *     {@link CARS520Event.CARSEventDetail.AccountingCode.Contingent }
             *     
             */
            public CARS520Event.CARSEventDetail.AccountingCode.Contingent getContingent() {
                return contingent;
            }
             ...
             *     
             */
            public void setContingent(CARS520Event.CARSEventDetail.AccountingCode.Contingent value) {
             ...
             * @return
             *     possible object is
             *     {@link CARS520Event.CARSEventDetail.AccountingCode.Adjustment }
             *     
             */
            public CARS520Event.CARSEventDetail.AccountingCode.Adjustment getAdjustment() {
                return adjustment;
            }
             ...
             *     
             */
            public void setAdjustment(CARS520Event.CARSEventDetail.AccountingCode.Adjustment value) {
