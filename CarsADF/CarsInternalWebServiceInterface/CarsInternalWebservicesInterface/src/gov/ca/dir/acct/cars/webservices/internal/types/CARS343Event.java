...
@XmlRootElement(name = "CARS343Event")
public class CARS343Event {
    ...
    protected CARS343Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS343Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS343Event.CARSEventHeader }
     *     
     */
    public CARS343Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS343Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS343Event.CARSEventDetail }
     *     
     */
    public CARS343Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS343Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS343Event.CARSEventDetail.AccountingCode accountingCode;
        ...
        protected CARS343Event.CARSEventDetail.Participants participants;
        @XmlElement(name = "Deposit", required = true)
        protected CARS343Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS343Event.CARSEventDetail.Receipt receipt;
         ...
         * @return
         *     possible object is
         *     {@link CARS343Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS343Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS343Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS343Event.CARSEventDetail.Participants }
         *     
         */
        public CARS343Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS343Event.CARSEventDetail.Participants value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS343Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS343Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS343Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS343Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS343Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS343Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
