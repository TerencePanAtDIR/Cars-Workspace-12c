...
@XmlRootElement(name = "CARS262Event")
public class CARS262Event {
    ...
    protected CARS262Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS262Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS262Event.CARSEventHeader }
     *     
     */
    public CARS262Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS262Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS262Event.CARSEventDetail }
     *     
     */
    public CARS262Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS262Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS262Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "Deposit", required = true)
        protected CARS262Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS262Event.CARSEventDetail.Receipt receipt;
        @XmlElement(name = "Amount", required = true)
        protected BigDecimal amount;
        @XmlElement(name = "NSFFeeAmount")
        protected BigDecimal nsfFeeAmount;
        @XmlElement(name = "Participants")
        protected CARS262Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS262Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS262Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS262Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS262Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS262Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS262Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS262Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS262Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS262Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS262Event.CARSEventDetail.Participants }
         *     
         */
        public CARS262Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS262Event.CARSEventDetail.Participants value) {
