...
@XmlRootElement(name = "CARS440Event")
public class CARS440Event {
    ...
    protected CARS440Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS440Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS440Event.CARSEventHeader }
     *     
     */
    public CARS440Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS440Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS440Event.CARSEventDetail }
     *     
     */
    public CARS440Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS440Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS440Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS440Event.CARSEventDetail.Participants }
         *     
         */
        public CARS440Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS440Event.CARSEventDetail.Participants value) {
