...
@XmlRootElement(name = "CARS446Event")
public class CARS446Event {
    ...
    protected CARS446Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS446Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS446Event.CARSEventHeader }
     *     
     */
    public CARS446Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS446Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS446Event.CARSEventDetail }
     *     
     */
    public CARS446Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS446Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS446Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS446Event.CARSEventDetail.Participants }
         *     
         */
        public CARS446Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS446Event.CARSEventDetail.Participants value) {
