...
@XmlRootElement(name = "CARS443Event")
public class CARS443Event {
    ...
    protected CARS443Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS443Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS443Event.CARSEventHeader }
     *     
     */
    public CARS443Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS443Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS443Event.CARSEventDetail }
     *     
     */
    public CARS443Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS443Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS443Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS443Event.CARSEventDetail.Participants }
         *     
         */
        public CARS443Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS443Event.CARSEventDetail.Participants value) {
