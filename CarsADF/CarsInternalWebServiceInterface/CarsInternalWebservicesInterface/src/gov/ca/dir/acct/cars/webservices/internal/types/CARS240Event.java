...
@XmlRootElement(name = "CARS240Event")
public class CARS240Event {
    ...
    protected CARS240Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS240Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS240Event.CARSEventHeader }
     *     
     */
    public CARS240Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS240Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS240Event.CARSEventDetail }
     *     
     */
    public CARS240Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS240Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS240Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "Amount", required = true)
        protected BigDecimal amount;
        @XmlElement(name = "Participants")
        protected CARS240Event.CARSEventDetail.Participants participants;
        @XmlElement(name = "Deposit", required = true)
        protected CARS240Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS240Event.CARSEventDetail.Receipt receipt;
         ...
         * @return
         *     possible object is
         *     {@link CARS240Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS240Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS240Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS240Event.CARSEventDetail.Participants }
         *     
         */
        public CARS240Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS240Event.CARSEventDetail.Participants value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS240Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS240Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS240Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS240Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS240Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS240Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
