...
@XmlRootElement(name = "CARS115Event")
public class CARS115Event {
    ...
    protected CARS115Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS115Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS115Event.CARSEventHeader }
     *     
     */
    public CARS115Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS115Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS115Event.CARSEventDetail }
     *     
     */
    public CARS115Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS115Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        @XmlElement(name = "AdjustmentTypeCode", required = true, defaultValue = "DECREASE")
        protected TAdjustmentType adjustmentTypeCode;
        @XmlElement(name = "AccountingCode")
        protected CARS115Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "Participants")
        protected CARS115Event.CARSEventDetail.Participants participants;
         ...
         * @return
         *     possible object is
         *     {@link CARS115Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS115Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS115Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS115Event.CARSEventDetail.Participants }
         *     
         */
        public CARS115Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS115Event.CARSEventDetail.Participants value) {
