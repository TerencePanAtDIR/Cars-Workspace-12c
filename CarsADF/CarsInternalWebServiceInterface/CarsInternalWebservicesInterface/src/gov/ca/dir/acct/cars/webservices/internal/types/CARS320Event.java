...
@XmlRootElement(name = "CARS320Event")
public class CARS320Event {
    ...
    protected CARS320Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS320Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS320Event.CARSEventHeader }
     *     
     */
    public CARS320Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS320Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS320Event.CARSEventDetail }
     *     
     */
    public CARS320Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS320Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS320Event.CARSEventDetail.AccountingCode accountingCode;
        ...
        protected CARS320Event.CARSEventDetail.Participants participants;
        @XmlElement(name = "Deposit", required = true)
        protected CARS320Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS320Event.CARSEventDetail.Receipt receipt;
         ...
         * @return
         *     possible object is
         *     {@link CARS320Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS320Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS320Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS320Event.CARSEventDetail.Participants }
         *     
         */
        public CARS320Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS320Event.CARSEventDetail.Participants value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS320Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS320Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS320Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS320Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS320Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS320Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
