...
@XmlRootElement(name = "CARS315Event")
public class CARS315Event {
    ...
    protected CARS315Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS315Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS315Event.CARSEventHeader }
     *     
     */
    public CARS315Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS315Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS315Event.CARSEventDetail }
     *     
     */
    public CARS315Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS315Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS315Event.CARSEventDetail.AccountingCode accountingCode;
        ...
        protected CARS315Event.CARSEventDetail.Participants participants;
        @XmlElement(name = "Deposit", required = true)
        protected CARS315Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS315Event.CARSEventDetail.Receipt receipt;
         ...
         * @return
         *     possible object is
         *     {@link CARS315Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS315Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS315Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS315Event.CARSEventDetail.Participants }
         *     
         */
        public CARS315Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS315Event.CARSEventDetail.Participants value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS315Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS315Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS315Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS315Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS315Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS315Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
