...
@XmlRootElement(name = "CARS230Event")
public class CARS230Event {
    ...
    protected CARS230Event.CARSEventHeader carsEventHeader;
    @XmlElement(name = "CARSEventDetail", required = true)
    protected CARS230Event.CARSEventDetail carsEventDetail;
     ...
     * @return
     *     possible object is
     *     {@link CARS230Event.CARSEventHeader }
     *     
     */
    public CARS230Event.CARSEventHeader getCARSEventHeader() {
     ...
     *     
     */
    public void setCARSEventHeader(CARS230Event.CARSEventHeader value) {
     ...
     * @return
     *     possible object is
     *     {@link CARS230Event.CARSEventDetail }
     *     
     */
    public CARS230Event.CARSEventDetail getCARSEventDetail() {
     ...
     *     
     */
    public void setCARSEventDetail(CARS230Event.CARSEventDetail value) {
    ...
    public static class CARSEventDetail {
        ...
        protected CARS230Event.CARSEventDetail.AccountingCode accountingCode;
        @XmlElement(name = "Amount", required = true)
        protected BigDecimal amount;
        @XmlElement(name = "Participants")
        protected CARS230Event.CARSEventDetail.Participants participants;
        @XmlElement(name = "Deposit", required = true)
        protected CARS230Event.CARSEventDetail.Deposit deposit;
        @XmlElement(name = "Receipt", required = true)
        protected CARS230Event.CARSEventDetail.Receipt receipt;
         ...
         * @return
         *     possible object is
         *     {@link CARS230Event.CARSEventDetail.AccountingCode }
         *     
         */
        public CARS230Event.CARSEventDetail.AccountingCode getAccountingCode() {
         ...
         *     
         */
        public void setAccountingCode(CARS230Event.CARSEventDetail.AccountingCode value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS230Event.CARSEventDetail.Participants }
         *     
         */
        public CARS230Event.CARSEventDetail.Participants getParticipants() {
            return participants;
        }
         ...
         *     
         */
        public void setParticipants(CARS230Event.CARSEventDetail.Participants value) {
         ...
         * @return
         *     possible object is
         *     {@link CARS230Event.CARSEventDetail.Deposit }
         *     
         */
        public CARS230Event.CARSEventDetail.Deposit getDeposit() {
            return deposit;
        }
         ...
         *     
         */
        public void setDeposit(CARS230Event.CARSEventDetail.Deposit value) {
            this.deposit = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link CARS230Event.CARSEventDetail.Receipt }
         *     
         */
        public CARS230Event.CARSEventDetail.Receipt getReceipt() {
            return receipt;
        }
         ...
         *     
         */
        public void setReceipt(CARS230Event.CARSEventDetail.Receipt value) {
            this.receipt = value;
        }
