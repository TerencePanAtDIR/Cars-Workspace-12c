...
public class OracleReportBean {
    ...
    private String report_named_param = null;
...
setReportServerParam(RS_PARAM_STATUSFORMAT,STATUSFORMAT_XML);*/
    ...
    private void constructURL() {
        ...
        reportURL.append("?");
        reportURL.append(report_named_param);
        reportURL.append("&");
    ...
    /**
     *Added by MJ 
     * Used for named param call
     * @param paramName
     */
    public void setReportNamedParam(String paramName){
        this.report_named_param = paramName;
