...
public class ContactMethodViewSDOImpl extends SDODataObject implements ContactMethodViewSDO {

   public static final int START_PROPERTY_INDEX = 0;

   public static final int END_PROPERTY_INDEX = START_PROPERTY_INDEX + 10;

   public ContactMethodViewSDOImpl() {}

   public java.math.BigDecimal getContactMethodId() {
      return getBigDecimal(START_PROPERTY_INDEX + 0);
   }

   public void setContactMethodId(java.math.BigDecimal value) {
      set(START_PROPERTY_INDEX + 0 , value);
   }

   public java.lang.String getContactMethodTypeCode() {
      return getString(START_PROPERTY_INDEX + 1);
   }

   public void setContactMethodTypeCode(java.lang.String value) {
   ...
   public void setContactMethodValue(java.lang.String value) {
