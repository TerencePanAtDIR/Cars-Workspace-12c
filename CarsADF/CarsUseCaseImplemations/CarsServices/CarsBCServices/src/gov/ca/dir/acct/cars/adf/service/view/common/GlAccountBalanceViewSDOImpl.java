...
public class GlAccountBalanceViewSDOImpl extends SDODataObject implements GlAccountBalanceViewSDO {

   public static final int START_PROPERTY_INDEX = 0;

   public static final int END_PROPERTY_INDEX = START_PROPERTY_INDEX + 9;

   public GlAccountBalanceViewSDOImpl() {}
   ...
   public java.math.BigDecimal getBalanceNumber() {
      return getBigDecimal(START_PROPERTY_INDEX + 1);
   }

   public void setBalanceNumber(java.math.BigDecimal value) {
   ...
   public void setBalanceDate(java.sql.Timestamp value) {
