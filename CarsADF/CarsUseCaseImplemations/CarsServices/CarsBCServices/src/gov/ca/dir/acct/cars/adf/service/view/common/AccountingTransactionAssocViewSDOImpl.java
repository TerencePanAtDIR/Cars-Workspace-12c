...
public class AccountingTransactionAssocViewSDOImpl extends SDODataObject implements AccountingTransactionAssocViewSDO {

   public static final int START_PROPERTY_INDEX = 0;

   public static final int END_PROPERTY_INDEX = START_PROPERTY_INDEX + 8;

   public AccountingTransactionAssocViewSDOImpl() {}

   public java.math.BigDecimal getAcctgTransactionFromId() {
      return getBigDecimal(START_PROPERTY_INDEX + 0);
   }

   public void setAcctgTransactionFromId(java.math.BigDecimal value) {
      set(START_PROPERTY_INDEX + 0 , value);
   }

   public java.math.BigDecimal getAcctgTransactionToId() {
      return getBigDecimal(START_PROPERTY_INDEX + 1);
   }

   public void setAcctgTransactionToId(java.math.BigDecimal value) {
