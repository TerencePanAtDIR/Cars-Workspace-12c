...
public class EventAssociationViewSDOImpl extends SDODataObject implements EventAssociationViewSDO {

   public static final int START_PROPERTY_INDEX = 0;

   public static final int END_PROPERTY_INDEX = START_PROPERTY_INDEX + 9;

   public EventAssociationViewSDOImpl() {}

   public java.math.BigDecimal getEventFromId() {
      return getBigDecimal(START_PROPERTY_INDEX + 0);
   }

   public void setEventFromId(java.math.BigDecimal value) {
      set(START_PROPERTY_INDEX + 0 , value);
   }

   public java.math.BigDecimal getEventToId() {
      return getBigDecimal(START_PROPERTY_INDEX + 1);
   }

   public void setEventToId(java.math.BigDecimal value) {
