...
public class OtherAccountTransViewSDOImpl extends SDODataObject implements OtherAccountTransViewSDO {

   public static final int START_PROPERTY_INDEX = 0;

   public static final int END_PROPERTY_INDEX = START_PROPERTY_INDEX + 7;

   public OtherAccountTransViewSDOImpl() {}
   ...
   public java.lang.String getOtherTransactTypeCode() {
      return getString(START_PROPERTY_INDEX + 1);
   }

   public void setOtherTransactTypeCode(java.lang.String value) {
      set(START_PROPERTY_INDEX + 1 , value);
   }

   public java.sql.Timestamp getOtherTransactionDate() {
      return (java.sql.Timestamp)get(START_PROPERTY_INDEX + 2);
   }

   public void setOtherTransactionDate(java.sql.Timestamp value) {
