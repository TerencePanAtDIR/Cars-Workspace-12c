...
public class AcctgTransactEventAssocViewSDOImpl extends SDODataObject implements AcctgTransactEventAssocViewSDO {

   public static final int START_PROPERTY_INDEX = 0;

   public static final int END_PROPERTY_INDEX = START_PROPERTY_INDEX + 8;

   public AcctgTransactEventAssocViewSDOImpl() {}
